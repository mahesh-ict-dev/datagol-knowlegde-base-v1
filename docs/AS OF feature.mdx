...
title : AS OF - Time travel feature 
---
...
1.  **Create a Custom or Dedup pipeline**. 
    ...
    -   Refer to [Creating Dedup pipeline](</docs/Lakehouse/Orchestrations/Creating Dedup pipeline.mdx>)
...
## Viewing the AS OF versions from Visualizer