...
![s3-datasource](/img/best-practices/S3-data-source.png)
...
![Sync Schema failure](/img/best-practices/sync-schema-failure.png)
...
![Partition column usage](/img/best-practices/partition-column-usage.png)
...
-	**Solution:**
	...
	![New Stream Selection](/img/best-practices/new-stream-selection.png)
...
![iceberg vs parquet](/img/best-practices/iceberg-vs-parquet.png)
...
![delete-protection](/img/best-practices/delete-protection.png)
...
![joins-between-existing-workbooks](/img/best-practices/joins-between-existing-workbooks.png)
...
![Athena support on playground](/img/best-practices/query-engines.png)
...
![persistent layer](/img/best-practices/persistent-layer.png)

Switching Data provider from Spark to JDBC:
![persistent layer](/img/best-practices/persistent-layer-storage.png)
...
-   Restricted Query Sources: BI queries can only be built on top of existing workbooks using view IDs or table IDs. They do not support querying directly from data sources or warehouses.
	...
	![bi query integration](/img/best-practices/bi-query-integration.png)
...
![workbook and bi formula](/img/best-practices/workbook-and-bi-formula-support.png)  
...
![workbook and bi formula](/img/best-practices/workbook-and-bi-formula-support-1.png)  
...
![playground](/img/best-practices/adding-a-limit.png)
