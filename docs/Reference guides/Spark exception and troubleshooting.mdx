...
-   **Symptoms:**
    ...
    -   Playground queries or Pipeline jobs failures.
        ...
        ![spark-exception](/img/spark-exception/att_1_for_335740930.png)
...
-   **Symptoms:**
    ...
    -   Queries or jobs fail.
        ...
        ![spark-exception](/img/spark-exception/att_3_for_335740930.png)    
        ![spark-exception](/img/spark-exception/att_2_for_335740930.png)    
