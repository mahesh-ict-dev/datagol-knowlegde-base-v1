...
sidebar_position : 4
tags: [Lineage]
slug: spark-exception-and-troubleshooting
---
...
-   **Symptoms:**
    ...
    -   Playground queries or Pipeline jobs failures.
        ...
        <ImagePopup src="/img/spark-exception/att_1_for_335740930.png" alt="spark-exception" caption="spark-exception" />
...
-   **Symptoms:**
    ...
    -   Queries or jobs fail.
        ...
        <ImagePopup src="/img/spark-exception/att_3_for_335740930.png" alt="spark-exception" caption="spark-exception" />    
        <ImagePopup src="/img/spark-exception/att_2_for_335740930.png" alt="spark-exception" caption="spark-exception" />    
