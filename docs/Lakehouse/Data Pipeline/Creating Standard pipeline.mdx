...
5.  From the **Sync mode** column, set the sync mode for the streams. Refer [Sync modes](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/220692503/DataGOL+Documentation#Sync-modes "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/220692503/DataGOL+Documentation#Sync-modes") for more information.
