...
3.  Specify the following details to add Snowflake. Once you have connected a data source, the system immediately fetches its schema. After this schema retrieval process is complete you can browse and interact with the tables and data.
...
Snowflake supports the following Sync modes:
