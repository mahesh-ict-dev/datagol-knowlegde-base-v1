...
3.  Specify the following details to add HubSpot. Once you have connected a data source, the system immediately fetches its schema. After this schema retrieval process is complete you can browse and interact with the tables and data.
...
HubSpot supports the following Sync modes:
...
HubSpot supports the following streams:

Here's your list with all the brackets and their contents removed:
...
-   Deals Records that have been deleted and stored in HubSpot's recycle bin will only be kept for 90 days.
