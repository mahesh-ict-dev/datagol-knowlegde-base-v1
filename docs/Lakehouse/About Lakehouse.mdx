...
Lakehouse is a hybrid data architecture, which provides a unified platform for storing diverse data (structured, semi-structured, unstructured) and performing advanced analytics. Key capabilities include:
...
-   [Data sources](/docs/Lakehouse/%20Data%20sources/About%20data%20sources)
    
-   [Pipelines](/docs/Lakehouse/Pipelines/about-pipelines)
