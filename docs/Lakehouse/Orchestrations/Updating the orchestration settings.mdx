...
slug: updating-the-orchestration-settings
---
...
3.  Click **Settings** and update the following:
     ...
     <ImagePopup src="/img/orchestration/image-20250512-062043.png" alt="viewing the orchestration run details" caption="viewing the orchestration run details" />
