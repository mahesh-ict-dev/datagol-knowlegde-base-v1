...
slug: viewing-the-orchestration-run-details
---
...
<ImagePopup src="/img/orchestration/image-20250512-061419.png" alt="viewing the orchestration run details" caption="viewing the orchestration run details" />
...
3.  Click the **Runs** tab. You can view the following details:
    ...
    -   **View Snapshot**: Click the link to view a quick snapshot of the details of the orchestration run. The snapshots of an orchestration run details the executed pipelines and their statuses at a given time, as your orchestration may not remain constant across different runs.
        ...
        <ImagePopup src="/img/orchestration/orchestration-snapshot.gif" alt="viewing the orchestration run details" caption="viewing the orchestration run details" />
