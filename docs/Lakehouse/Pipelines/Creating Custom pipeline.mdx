...
2.  In the **Pipelines** page, from the upper right corner, click **+ New Pipeline** button.
    ...
    <ImagePopup src="/img/image-20250505-095927.png" alt="sample" caption="sample" />
    
3.  Select **Custom** for tailored data extraction with user-defined queries.
    
4.  Provide a name for the Output table.
    
5.  Define your data with precision by creating custom queries to suit your specific needs. You have the flexibility to view your data sources, add queries, format your queries and also run, format, and test your queries.
    
    <ImagePopup src="/img/image-20250505-130231.png" alt="sample" caption="sample" />
