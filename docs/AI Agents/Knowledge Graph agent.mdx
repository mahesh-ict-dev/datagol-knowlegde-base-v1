...
2.  Select a document (e.g., a PDF), click more options and select *Knowledge Graph*. If a graph is already created, it will be displayed, else, you will have to create the Knowledge Graph. See steps below. 
...
3.  Click the **Start Creating Graph** button.
    ...
    <ImagePopup src="/img/AI/knowledge-graph/knowledge-transer-create.png" alt="knowledge-graph" caption="Knowledge graph"/>
...
3.  [Use the controls](#control-graph-limits) to adjust the sample of the graph being displayed:
...
2.  Adjust the Lower/Upper Limit:

    -   To view a smaller, cleaner portion of the graph, enter a **lower number** (e.g., 10 or 20) into the relevant field. The graph will reload to show only that number of nodes/edges.
