...
1.  **Click "Add Context":** In the RAG Agent UI, click the new **Add context** option. This opens a selector showing all content in your current workspace.

	<ImagePopup src="/img/AI/rag-agent-add-context.png" alt="*actions library" caption="*rag-agent-add-context" />  
    
2.	**Select your sources:**
    
    -   You can choose any **folder** or **AI-ready document**.
        
    -   Documents that are not yet processed or are incompatible file types will be grayed out and cannot be selected.
