...
### 1. Indexing Status Overview
See the overall indexing progress at a glance, including the percentage of files indexed and the last indexed timestamp.
### 2. Incremental Index
Process only newly added or updated documents, keeping your index current without a full reprocess.
### 3. Full Reindex
Reprocess all documents in your workspace to ensure the AI search index is completely up to date.
### 4. File-Level Status Visibility
Browse and search individual files to see whether each document is **AI Ready** or still pending — so you know exactly what your RAG agent can reference when answering questions.

<ImagePopup src="/img/agents/doc-index-settings.png" alt="doc-index-settings" caption="Document Index Settings"/>


### 5. Audio & Video Files Now Supported in Workspace Documents
