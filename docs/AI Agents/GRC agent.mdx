...
1.  **Standards Policy folder:** The **Source of Truth** containing documents that define the ideal rules (e.g., ISO standards, internal IT governance).
    
2.  **Target Policy folder:** The documents belonging to the company being audited (e.g., their specific password policy or access logs).
