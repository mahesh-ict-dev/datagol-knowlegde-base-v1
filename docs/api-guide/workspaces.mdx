...
<div className="endpoint-card">
  <div className="endpoint-header">
    ...
    <code className="endpoint-url">https://be.datagol.ai/noCo/api/v2/workspaces</code>
  </div>
...
<div className="endpoint-card">
  <div className="endpoint-header">
    <span className="method-badge method-post">POST</span>
    <code className="endpoint-url">https://be.datagol.ai/noCo/api/v2/workspaces/:workspaceId/bulkUsers</code>
  </div>
