...
<div className="endpoint-card">
  ...
  <div className="endpoint-body">
    <div>This endpoint creates a new workspace in the DataGOL Platform. Workspaces help organize users, resources, and configurations within the platform.</div>
...
<div className="endpoint-card">
  ...
  <div className="endpoint-body">
    <div>This endpoint allows you to add multiple users to a specific workspace in a single request. Each user is assigned a role within the workspace.</div>
