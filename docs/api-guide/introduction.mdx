...
<div className="workflow-step">
  ...
  <div className="step-content">
    ...
    <div>Use JWT to create or reset a service account token</div>
  </div>
</div>
...
<div className="next-steps">
  <div className="step-card">
    ...
    <div>Using <strong>Claude Code</strong> or <strong>Cursor</strong>? Feed them this spec to make the API "self-understandable".</div>
...
<div className="step-card">
  ...
  <div className="step-card">
    ...
    <div>Understand the step-by-step sequence of API calls required to build a full application.</div>
