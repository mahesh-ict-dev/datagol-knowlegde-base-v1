...
sidebar_position: 4
tags: [Playground, Sql]
slug: create-queries-with-ai-assitance-in-playground
---
...
1.  On the **Home** page, from left navigation panel, click **Playground** and then click the AI icon from the upper right corner to open the SQL Copilot window.
    
    <ImagePopup src="/img/playground/image-20250324-132809.png" alt="creating queries with AI assistance in playground1" caption="creating queries with AI assistance in playground1" />
    
2.  Click the **Select Data Sources**, select the required data sources and click **Apply**. You can select up to five data sources.
    
3.  In the chat input area, you can choose from a list of open **AI models** such as **GPT-4o**.
    
4.  In the chat input area, describe your desired SQL query using natural language. The AI will generate the corresponding SQL query.
    
     <ImagePopup src="/img/playground/image-20250324-134953.png" alt="creating queries with AI assistance in playground2" caption="creating queries with AI assistance in playground2" />
    
5.  Review the generated query for accuracy and click the **Run** button to execute the query within the Playground and view the output.
    
6.  Copy the generated query to the SQL editor and use [these steps](creating-queries-in-playground-with-sql-query) to save the query.
