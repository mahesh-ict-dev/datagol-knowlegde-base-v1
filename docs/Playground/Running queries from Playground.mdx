...
1.  On the **Home** page, from the left navigation panel, click **Playground** and [create a query](/docs/playgrounds/create-queries-in-playground) or click the **Query** tab and select an existing query.
