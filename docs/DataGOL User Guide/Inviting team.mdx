...
1. On the DataGOL home page, from the right side, click the **Go to Team** button. This will take you to the Team page.  
   ...
   <ImagePopup src="/img/image-20250506-125208.png" alt="Go to teams" caption="Go to teams" />
   
2. From the upper right side, click the **Invite** button. The **Invite a member** box is displayed.  

   <ImagePopup src="/img/image-20250506-125413.png" alt="invite" caption="invite" />
...
| **BI Dashboard Admin** | Can view and edit all External Dashboards created within the company.                            |
