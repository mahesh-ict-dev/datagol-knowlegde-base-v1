...
1. From the left side of the Home page, select **Company**. 
   <ImagePopup src="/img/image-20250506-135902.png" alt="Company Settings" caption="Company Settings" />
3. Select the **Keys** tab.
   <ImagePopup src="/img/image-20250506-164725.png" alt="AWS Keys Tab" caption="AWS Keys Tab" />
...
3.  
   <ImagePopup src="/img/image-20250506-170104.png" alt="Azure Keys Tab" caption="Azure Keys Tab" />
