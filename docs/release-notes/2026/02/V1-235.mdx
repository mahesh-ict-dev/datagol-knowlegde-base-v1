...
-   **Support for Claude 4.6 Sonnet** is now available. This update provides a significant boost in reasoning, coding proficiency, and instruction following while maintaining high execution speeds.
