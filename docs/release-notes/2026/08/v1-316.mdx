...
- [Scheduled PDF Delivery for Dashboards](/docs/BI%20Analytics/schedule-dashboard) You can now schedule automated PDF delivery of a dashboard or individual widget to your email on a recurring basis. Configure the recipient list, frequency, delivery time, and relative date range — such as "last 7 days" — and DataGOL will generate and send the report automatically at the scheduled time. 
