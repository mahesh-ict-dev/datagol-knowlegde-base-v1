...
-   [KPIs, Line chart, Bar chart, Donut chart, Pivot tables,](</docs/BI Analytics/Widgets/Widget Types.mdx>) etc.   
-   [Drill-downs](</docs/BI Analytics/Drill Down/Drill Down - Widget.mdx>), [Filters](</docs/BI Analytics/Widgets/Widget Filters.mdx>), and exploration mode.  

**Key Points:**

-   Widgets use [formulas](</docs/BI Analytics/Formulas & Parameters/BI Formula.mdx>) and [parameters](</docs/BI Analytics/Formulas & Parameters/Parameters.mdx>) 
...
2.  Once whitelisted, you can create a new data source from the [**Data Sources**](</docs/Lakehouse/Data sources/About Data sources.mdx>) page with the appropriate connector and active credentials. 
...
Also refer:
-   [Creating dashboards](</docs/BI Analytics/Dashboards/Dashboards.mdx>)
-   [Managing layout and widgets in a dashboard](</docs/BI Analytics/Dashboards/Dashboards.mdx>)
