...
slug: bi-widgets-capabilities-combinations
---
...
-   [KPI (Key Performance Indicator) widget](#KPI-widget)
    
-   [Line/Area/Scatter Chart](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%F0%9F%93%88-Line%2FArea%2FScatter-chart "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%F0%9F%93%88-Line%2FArea%2FScatter-chart")
    
-   [Pie/Donut/Funnel Chart](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%E2%AD%95-Pie%2FDonut%2FFunnel-chart "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%E2%AD%95-Pie%2FDonut%2FFunnel-chart")
    
-   [Table Widget](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%F0%9F%93%9C-Table-Widget "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%F0%9F%93%9C-Table-Widget")
    
-   [Pivot Table Widget](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%F0%9F%94%84-Pivot-table-widget "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#%5BinlineExtension%5D%F0%9F%94%84-Pivot-table-widget")
    
-   [Packed Bubble Chart](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#Packed-Bubble-chart "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#Packed-Bubble-chart")
    
-   [Treemap](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#Treemap "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#Treemap")
    
-   [Boxplot](https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#Boxplot "https://saasxl.atlassian.net/wiki/spaces/documentation/pages/402685965/BI+widget+capabilities+and+chart+combinations#Boxplot")
...
-   **1 Dimension, 1 Metric (1D 1M)**
    ...
    -   **Key Capabilities:** Visualize magnitude differences, apply percentage stacking to see contribution to total, drill down for details.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-135855.png)
...
-   **1 Metric, 1 Date Time (Truncated) (1M 1DTT)**
    ...
    -   **Key Capabilities:** Observe performance over selected time periods, change metric aggregation (sum, average, count), drill down.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-140137.png)
...
-   **1 Metric, 1 Date Time (Part) (1M 1DTP)**
    ...
    -   **Key Capabilities:** See performance by specific time segments (hour, day of week, month of year), change metric aggregation, drill down.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-140330.png)
...
-   **Multiple Metrics, 1 Date Time (Truncated) (MM 1DTT)**
    ...
    -   **Key Capabilities:** Visualize multiple metric trends simultaneously, change chart type for individual metrics (e.g., one bar, one line), merge axes for comparison, drill down.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-141017.png) 
...
-   **Multiple Metrics, 1 Date Time (Part) (MM 1DTP)**
    ...
    -   **Key Capabilities:** Analyze correlations between metrics across time segments, change chart type for individual metrics, merge axes, drill down.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-141132.png) 
...
-   **1 Metric, 1 Date Time (Truncated), 1 Date Time (Part) (1M 1DTT 1DTP)**
    ...
    -   **Key Capabilities:** Group by a primary time unit and then sub-group by a date part, apply stacking (normal/percent).  
         ...
         ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-141428.png) 
...
-   **1 Dimension, 1 Date Time (Truncated), 1 Metric (1D 1DTT 1M)**
    ...
    -   **Key Capabilities:** Group by dimension and then by time (or vice-versa), apply percentage stacking, drill down.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-141550.png) 
...
-   **1 Dimension, 1 Date Time (Part), 1 Metric (1D 1DTP 1M)**
    ...
    -   **Key Capabilities:** Group by dimension and then by date part (or vice-versa), apply percentage stacking, drill down.  
         ...
         ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-142157.png) 
...
-   **2 Dimensions, 1 Metric (2D 1M)**
    ...
    -   **Key Capabilities:** Create stacked or grouped bars based on a second dimension, apply percentage stacking, drill down.  
         ...
         ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-142540.png)
...
-   **Multiple Metrics, 1 Dimension (MM 1D)**
    ...
    -   **Key Capabilities:** Visualize multiple performance aspects per category, merge axes, change chart types for individual metrics, drill down.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-145408.png)
...
-   **1 Metric (1M)**
    ...
    -   **Key Capabilities:** Highlight a key performance figure, change metric aggregation.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-153105.png)
...
-   **1 Metric, 1 Date Time (Truncated) (1M 1DTT)**
    ...
    -   **Key Capabilities:** View metric for a selected time bucket (monthly, yearly, etc.), apply filters.  
        ...
        ![bi-widgets-capabilities-combinations1](/img/visualizer/image-20250514-153212.png)
