...
1.  On the Home page, from the left navigation panel, click Playground and [create a query](docs/Playgrounds/About).
    
2.  Click Publish from the upper right corner of the page. The Publish to Workspace box is displayed.
    
3.  `![Open](/img/image-20250511-185653.png)`
    
4.  Enter the following details:
    
5.  `![Open](/img/image-20250511-185744.png)`
    

-   From the Workspace drop down select the workspace where you want to publish the query. You can publish a query only to an [existing workspace](docs/Workspaces/Creating%20workspace) where you have owner, creator, or editor permissions.
