...
sidebar_position: 4
tags: [Playground, Sql]
slug: connecting-external-data-via-playground
---
...
1.  **Identify the Workbook table name:**
    ...
    2.  Click the more options icon next to a workbook. The table name is revealed at the end of the dropdown. Click the adjacent copy icon to copy the table name.
        ...
        ![connecting external data to your workbook via playground](Image static/img/playground/image-20250512-073420.png)
