...
In DataGOL, you can apply any of the following functions to selected columns when you [visualize data via chart widgets](</docs/BI Analytics/Visualizer/Creating visualization or widget.mdx>).
