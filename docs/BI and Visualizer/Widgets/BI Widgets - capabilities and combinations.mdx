...
-   [Line/Area/Scatter Chart](#lineareascatter-chart)
    
-   [Pie/Donut/Funnel Chart](#piedonutfunnel-chart)
...
-   **1 Metric, 1 Date Time (Truncated) (1M 1DTT)**
    ...
    -   **Key Capabilities:** View metric for a selected time bucket (monthly, yearly, etc.), apply filters.  
        ...
        <ImagePopup src="/img/visualizer/image-20250514-153212.png" alt="bi-widgets-capabilities-combinations1" caption="bi-widgets-capabilities-combinations1" />
