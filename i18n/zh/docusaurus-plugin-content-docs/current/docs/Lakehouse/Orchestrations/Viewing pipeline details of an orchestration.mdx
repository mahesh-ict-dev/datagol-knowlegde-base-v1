...
slug: viewing-pipeline-details-of-an-orchestration
---
...
3.  Click the **Pipelines** tab. You can view the following details:
    ...
    <ImagePopup src="/img/orchestration/image-20250512-042449.png" alt="viewing orchestration graph" caption="viewing orchestration graph" />
    ...
    -   **Last Job**: Provides status of the job run. Click any status to view more job run details.
        ...
        <ImagePopup src="/img/orchestration/image-20250512-043457.png" alt="viewing orchestration graph" caption="viewing orchestration graph" />
