...
slug: adding-members-to-orchestration
---
...
3.  In the **Summary** page, click the **Add** button.
    ...
    <ImagePopup src="/img/orchestration/image-20250511-164540.png" alt="adding members to orchestration" caption="adding members to orchestration" />
    
4.  In the **Add members to Orchestration** box, select the users whom you want to add to the orchestration and click **Add**.
    
    <ImagePopup src="/img/orchestration/image-20250511-164731.png" alt="adding members to orchestration" caption="adding members to orchestration" />