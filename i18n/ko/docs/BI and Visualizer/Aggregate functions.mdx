...
In DataGOL, you can apply any of the following functions to selected columns when you [visualize data via chart widgets](/docs/BI%20and%20Visualizer/Widgets/create-visualization-or-create-widget).
