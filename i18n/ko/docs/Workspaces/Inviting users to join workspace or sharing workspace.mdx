...
slug : inviting-users-to-join-a-workspace-sharing-a-workspace
---
...
2.  Click the three dots on the workspace icon and select **Share**. The **Share _Workspace_ box is displayed.
    
     <ImagePopup src="/img/image-20250427-125110.png" alt="inviting-users-to-join-a-workspace-sharing-a-workspace" caption="inviting-users-to-join-a-workspace-sharing-a-workspace" /> 
    
3.  In the **Add People** text box, you can specify the email ID of the users whom you want to add and press ENTER.
...
5.  Optionally, you can add a message for the user and click **Add**. An invite to access the workspace with the selected permissions is sent to the specified email ID.
    
    <ImagePopup src="/img/image-20250427-133224.png" alt="inviting-users-to-join-a-workspace-sharing-a-workspace" caption="inviting-users-to-join-a-workspace-sharing-a-workspace" /> 

6.  Click **Accept Invitation** in the email invite to join the workspace.